...
<%
  ...
  supCombo.separator="";
  pageState.addClientEntry("NEW_SERVICE_TYPE_"+rowLine, pageState.getEntry("SERVICE_TYPE_ID").stringValue());
  ...
  pageState.addClientEntry("NEW_SERVICE_CONTENT_"+rowLine, pageState.getEntry("SERVICE_CONTENT_ID").stringValue());
