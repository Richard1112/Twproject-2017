<%@ page import="
 ...
 org.jblooming.utilities.StringUtilities, org.jblooming.waf.view.PageState, java.util.Map, com.twproject.security.TeamworkPermissions, org.jblooming.security.License"
%><%@ page pageEncoding="UTF-8"%><%
  ...
  exception.setWorking(false); */
    ...
    response.setHeader("content-disposition", "inline; filename=" + filenameEncoded + ".xml");
