...
<div class="mainColumn">
  ...
  <%
    ...
    SmartCombo resourceCombo = ResourceBricks.getInspectableResourcesCombo("RES_ID", CollectionUtilities.toList(TeamworkPermissions.expense_manage), pageState);
