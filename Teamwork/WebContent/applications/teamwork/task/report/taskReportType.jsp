  ...
  if (!pageState.screenRunning) {
    ...
    if (Commands.SAVE.equals(pageState.command)) {
      ...
      for (String id : map.keySet()) {
    	...
    	TaskReportType t = (TaskReportType) PersistenceHome.findByPrimaryKey(TaskReportType.class, id);
      ...
      if (newDesc != null) {
    	TaskReportType t = new TaskReportType();
...
%><table class="table"><tr><th class="tableHead">Id</th><th class="tableHead"><%=I18n.get("REPORTTYPE")%></th><th class="tableHead"><%=I18n.get("DESCRIPTION")%></th><th class="tableHead"><%=I18n.get("DELETE_SHORT")%></th></tr><%
...
%>
  ...
  %><td colspan="2"><%tf.toHtml(pageContext);%></td></tr><%
    ...
    new DeletePreviewer("OBJ_DEL", TaskReportType.class.getName(), pageState);
