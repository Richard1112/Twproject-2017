...
//   }
  ...
  PageSeed editDoc = pageState.pageFromRoot(document.getTask()!=null ? "task/taskReportEditor.jsp" : "resource/resourceDocumentEditor.jsp");
  editDoc.mainObjectId = document.getId();
  editDoc.command= Commands.EDIT;
  editDoc.addClientEntry("TASK_ID",document.getTaskId());
...
//  pageState.addClientEntry("RELATIVE_FILE_DIR1", document.getTask().getCode()+"/"+document.getTaskReportType().getStringValue());
//  AHref bl3 = document.bricks.getExportLink(pageState,"RELATIVE_FILE_DIR1");
 
//  pageState.addClientEntry("RELATIVE_FILE_DIR2", document.getTask().getCode()+"/"+document.getTaskReportType().getStringValue());
//  AHref bl4 = document.bricks.getExportLink(pageState,"RELATIVE_FILE_DIR2");
...
<tr class="alternate" reportId="<%=document.getId()%>">
  ...
  %></td>
  <td><a href="<%=bl2.href%>"><%=document.getTaskReportType().getStringValue()%></a> </td>
