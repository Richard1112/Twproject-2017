...
(function(win) {
	...
	var tinymce = {
		...
		// T odo: remove me once MS fixes the bug
...
(function(tinymce) {
	...
	tinymce.html.Schema = function(settings) {
		...
		// T odo: Remove this when we fix list handling to be valid
...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.DOMUtils', {
		...
		clone: function(node, deep) {
			...
			// T ODO: Add feature detection here in the future
...
var Expr = Sizzle.selectors = {
	...
	preFilter: {
		...
		CHILD: function( match ) {
			...
			// T ODO: Move to normal caching system
			match[0] = done++;
...
(function(tinymce) {
	tinymce.dom.Serializer = function(settings, dom, schema) {
		...
		// Fix list elements, T ODO: Replace this later
...
(function(tinymce) {
	tinymce.dom.ScriptLoader = function(settings) {
		...
		function loadScript(url, callback) {
			...
			// t odo: Removed since it produced error if the document is unloaded by navigating away, re-add it as an option
...
tinymce.create('tinymce.ui.ToolbarGroup:tinymce.ui.Container', {
	renderHTML : function() {
		...
		//T ODO: ACC test this out - adding a role = application for getting the landmarks working well.
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			// Create iframe
			// T ODO: ACC add the appropriate description on this.
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			'InsertUnorderedList,InsertOrderedList' : function(command) {
				...
				// T ODO: Remove this when the list creation logic is removed
	...
	tinymce.Formatter = function(ed) {
				...
				each(newWrappers, function(node) {
					...
					if (format.inline || format.wrapper) {
						...
						each(formatList, function(format) {
							...
							// this: <span style="color:#DB2727"><b><span style="color:red; font-size:10px">text</span></b></span>
							// will become: <span style="color:#DB2727"><b><span style="font-size:10px">text</span></b></span>
		...
		function performCaretAction(type, name, vars) {
			...
			function createCaretContainer(fill) {
				var caretContainer = dom.create('span', {id: caretContainerId, 'data-mce-bogus': true, style: debug ? 'color:#DB2727' : ''});
