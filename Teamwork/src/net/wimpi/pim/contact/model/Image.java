...
/**
 * An interface modeling an image based on the
...
public interface Image
  ...
  /**
   * Tests if this <tt>Image</tt> is given as
   * an URI reference.
   *
  ...
  /**
   * Returns the content type of this <tt>Image</tt>.
   *
  ...
  /**
   * Sets the content type of this <tt>Image</tt>.
   *
   ...
   * access to the data of this <tt>Image</tt>.
   * <p>
