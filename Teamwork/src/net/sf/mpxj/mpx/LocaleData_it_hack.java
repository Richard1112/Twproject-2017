 ...
 */
public final class LocaleData_it_hack extends ListResourceBundle {
  /**
   * {@inheritDoc}
   */
  @Override
  ...
  //private static final String[] TIME_UNITS_ARRAY_DATA = {"r", "o", "g", "s", "mes", "a", "%", "tr", "to", "tg", "ts", "tm", "ta", "t%"};
  private static final String[] TIME_UNITS_ARRAY_DATA = {"m", "h", "g", "w", "mes", "a", "%", "fm", "fh", "fg", "fw", "fmes", "fa", "f%"};
