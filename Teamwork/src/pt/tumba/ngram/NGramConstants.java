...
public class NGramConstants {
	...
	//public final static int USEDNGRAMSMAX = -1;
	 ...
	 */
	public final static boolean SMOOTHING = false;

	/** 
	 * The number of characters (n) for each n-gram.
	 */
	public final static int NUMCHARACTERS = 5;
