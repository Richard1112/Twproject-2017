...
public class PropertiesParseHelper {
	...
	public static boolean isExclusiveIndexUsageEnabled(Properties indexProps) {
		// MODIFIED return ConfigurationParseHelper.getBooleanValue( indexProps, Environment.EXCLUSIVE_INDEX_USE, true );
		return ConfigurationParseHelper.getBooleanValue( indexProps, Environment.EXCLUSIVE_INDEX_USE, false );
	}
